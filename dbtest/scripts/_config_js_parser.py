...
class ConfigJsParser(HTMLParser):
    ...
    def parse_photo_img(self, attrs: list) -> None:
        self.data["photo"]["alt"] = ConfigJsParser.retrieve_attr(attrs, "alt", "")
        self.data["photo"]["image_src"] = ConfigJsParser.retrieve_attr(attrs, "src", "")

    def parse_photo_link(self, attrs: list) -> None:
        self.data["photo"]["link"] = ConfigJsParser.retrieve_attr(attrs, "href", "")

    def parse_photo_prof(self, data: str) -> None:
        result = ConfigJsParser.PHOTO_PROF_PATTERN.match(data)
